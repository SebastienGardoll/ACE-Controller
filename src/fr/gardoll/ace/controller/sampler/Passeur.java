...
public class Passeur implements Closeable
{
  ...
  public void finMoveCarrousel()
  {
    ...
    { 
      ...
      {
        String msg = String.format("interruption while waiting for the end of the sampler plate move: %s",
            e.getMessage());
        _LOG.debug(msg);
      }
  ...
  public void finMoveBras()
  {
    try
    {
      ...
      { 
        ...
        {
          String msg = String.format("interruption while waiting for the end of the sampler harm move: %s",
              e.getMessage());
          _LOG.debug(msg);
        }
  ...
  { 
    ...
    {
      String msg = String.format("error while resetting the sampler interface: %s", e.getMessage());
      _LOG.fatal(msg);
      throw new RuntimeException(msg, e);
    }
  }
  ...
  {  
    ...
    {
      String msg = String.format("error while setting sampler direct mode: %s", e.getMessage());
      _LOG.fatal(msg);
      throw new RuntimeException(msg, e);
    }
  }
  ...
  { 
    ...
    {
      String msg = String.format("error while setting sampler manual mode: %s", e.getMessage());
      _LOG.fatal(msg);
      throw new RuntimeException(msg, e);
    }
  }
  ...
  public void pause()
  {
    ...
    {
      String msg = String.format("error while pausing the sampler: %s", e.getMessage());
      _LOG.fatal(msg);
      throw new RuntimeException(msg, e);
    }
  }
    ...
    if (this._pause)
    {
      ...
      { 
        ...
        else
        {
          ...
          {
            String msg = String.format("error while resuming the sampler move: %s", e.getMessage());
            _LOG.fatal(msg);
            throw new RuntimeException(msg, e);
          }
        }
  ...
  {  
    ...
    {
      String msg = String.format("interruption while vibrating the sampler harm: %s", e.getMessage());
      _LOG.debug(msg);
    }
  }
